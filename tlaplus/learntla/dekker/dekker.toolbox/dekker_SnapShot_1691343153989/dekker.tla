...
define  
  ...
  CorrectThreadEnteredInCriticalSection ==
     (Cardinality(criticalSectionVisitor) = 1) => turn \in criticalSectionVisitor
end define; 
...
\* BEGIN TRANSLATION (chksum(pcal) = "dddad103" /\ chksum(tla) = "1b730718")
...
\* Last modified Mon Aug 07 01:32:06 HKT 2023 by raventid
